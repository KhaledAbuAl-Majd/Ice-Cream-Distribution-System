...
using Khaled_Control_Library_;
using Khaled_Control_Library_.net8;
...
namespace MoneyMindManager_Presentation.Global
{
    public static class clsPL_Utils
    {
        ...
        public static string GetValidationErrorTypeString(KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType validationErrorType,KhaledGuna2TextBox kgtxtBox)
        {
            ...
            {
                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.General:
                    errorMessage = "برجاء إدخال قيمة مناسبة";
                    break;

                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.IsRequired:
                    errorMessage = "هذا الحقل مطلوب";
                    break;

                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.WhiteSapceError:
                    errorMessage = "غير مسموح بالمسافات, برجاء إدخال قيمة صالحة";
                    break;

                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.NotValidIntegerNumber:
                    errorMessage = "برجاء إدخال رقم صحيح";
                    break;

                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.NotValidFloatNumber:
                    errorMessage = "برجاء إدخل رقم عشرى مناسب";
                    break;

                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.NotValidDecimalNumber:
                    errorMessage = "برجاء إدخل رقم عشرى مناسب";
                    break;

                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.SkipNumberMinValue:
                    {
                ...
                case Khaled_Control_Library_.net8.KhaledGuna2TextBox.ValidatingErrorEventArgs.enValidationErrorType.SkipNumberMaxValue:
                    {
